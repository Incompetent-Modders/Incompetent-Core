...
public record ClassType(boolean canCastSpells, int maxMana, boolean pacifist, boolean useClassSpecificTexture, Ability ability, ClassPassiveEffect passiveEffect) {
    public static final Codec<ClassType> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Ability.DIRECT_CODEC.optionalFieldOf("ability", null).forGetter(ClassType::ability),

...
public class PlayerDataCore {
    ...
    public static void handleClassDataTick(Player player, PlayerTickEvent event) {
    ...
    public static void handleSpeciesDataTick(Player player, PlayerTickEvent event) {

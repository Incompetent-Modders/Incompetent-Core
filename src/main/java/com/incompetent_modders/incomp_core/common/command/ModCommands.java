...
import com.incompetent_modders.incomp_core.common.command.qol.ApplyBonemealCommand;
import com.incompetent_modders.incomp_core.common.command.qol.ExplodeCommand;
import com.incompetent_modders.incomp_core.common.command.qol.ShootFromRotationCommand;
...
public class ModCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext context) {
        LiteralArgumentBuilder<CommandSourceStack> root = Commands.literal("incompetent_core")
                ...
                .then(SetClassCommand.register(context))
                ...
                .then(ToggleWelcomeMessageCommand.register(context))
                ;

...
public class SpellListOverlay implements IGuiOverlay {
    ...
    public void render(ExtendedGui gui, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        Spell spellMainHand = castingMainHand instanceof SpellCastingItem castingItem ? castingItem.getSelectedSpell(player.getItemInHand(InteractionHand.MAIN_HAND)) : Spells.EMPTY.get();
        Item castingOffHand = player.getItemInHand(InteractionHand.OFF_HAND).getItem();
        Spell spellOffHand = castingOffHand instanceof SpellCastingItem castingItem ? castingItem.getSelectedSpell(player.getItemInHand(InteractionHand.OFF_HAND)) : Spells.EMPTY.get();
        ...
        boolean isMainHandSpell = player.getItemInHand(InteractionHand.MAIN_HAND).getItem() instanceof SpellCastingItem;
        boolean isOffHandSpell = player.getItemInHand(InteractionHand.OFF_HAND).getItem() instanceof SpellCastingItem;

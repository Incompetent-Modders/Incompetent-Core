...
public class ModEffects {
    ...
    public static final DeferredHolder<MobEffect, MobEffect> ZOMBIE_VIRUS = EFFECTS.register("zombie_virus", () -> new SpeciesAlteringEffect(MobEffectCategory.NEUTRAL, 0x33703e, CommonUtils.location("zombie")));
